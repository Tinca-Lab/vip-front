  ...
  <div class="px-5 py-32 h-full background">
    <Transition name="bounce">
      <div v-if="isShowing" class="flex flex-col h-full justify-center items-center">
        ...
        <span
          v-else
          class="bg-white bg-opacity-60 w-full backdrop-blur backdrop-filter rounded-3xl flex items-center justify-between py-5 px-5"
        >
      <span
      ...
      <img src="@/assets/shortcuts/service.svg" alt="Servicios"/>
        ...
        <button
          class="block mx-auto bg-blue-400 rounded-xl hover:bg-blue-500 duration-200 ease-out px-5 py-3 text-white font-bold my-7"
          type="button"
          @click="toggleView"
        >
          Agregar Servicio
