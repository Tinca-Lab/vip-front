<template>
  <div>
    ...
    >
      ...
      >
        <div
          class="text-indigo-500 flex flex-col items-center justify-center my-5"
        >
          <svg
            width="80"
            height="80"
          ...
          >
            ...
            />
            <path
              d="M50.5 32.25L35.375 47.375L28.5 40.5"
              stroke="white"
              stroke-width="2"
          ...
          <h1 class="uppercase text-2xl font-bold text-black">
        ...
        <CodeInput
          ...
          @complete="onComplete"
        />
        <span class="mt-3 cursor-pointer underline italic" @click="onResend"
          >No me llego el codigo de verificacion, reenviar.</span
        >
        <button
          type="button"
