<template>
  <div class="admin">
    <div class="flex flex-col h-screen wrap relative">
      <header>
        <nav
          class="fixed z-50 w-full top-0 flex flex-col items-center pt-10"
        >
          <nuxt-link
            v-if="path !== 'dashboard'" to="/admin/dashboard"
        ...
        Volver
          ...
          <div class="flex items-center justify-between w-full px-5">
            <div class="flex">
              <span>👋🏻</span>
              <p v-if="$auth.user" class="text-lg tracking-wide text-blue-500 font-semibold">
                Hola, {{ user }}
              </p>
            </div>
            <div class="relative">
      ...
      <span class="text-blue-300">
       <svg width="34" height="26" viewBox="0 0 34 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
